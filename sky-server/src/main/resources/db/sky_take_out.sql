/*
 ...
 Source Schema         : skt_take_out

 Target Server Type    : MySQL
 Target Server Version : 80037 (8.0.37)
 File Encoding         : 65001

 Date: 02/08/2024 22:21:43
*/
...
-- ----------------------------
INSERT INTO `address_book` VALUES (1, 2, '12', '0', '18767683132', '11', '北京市', '1101', '市辖区', '110102', '西城区', '12', '2', 0);
...
INSERT INTO `category` VALUES (16, 1, '蜀味烤鱼', 5, 1, '2022-06-09 22:15:37', '2022-08-31 14:27:25', 1, 1);
INSERT INTO `category` VALUES (17, 1, '蜀味牛蛙', 2, 1, '2022-06-09 22:16:14', '2024-03-23 23:44:50', 1, 1);
...
INSERT INTO `category` VALUES (21, 1, '汤类', 54, 1, '2022-06-10 10:51:47', '2024-03-23 23:44:26', 1, 1);
INSERT INTO `category` VALUES (24, 2, '豪华套餐', 1, 1, '2024-03-24 17:29:44', '2024-03-24 17:29:44', 1, 1);
...
INSERT INTO `dish` VALUES (63, '香锅牛蛙', 17, 88.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/f5ac8455-4793-450c-97ba-173795c34626.png', '配料：鲜活牛蛙，莲藕，青笋', 0, '2022-06-10 10:35:40', '2024-03-24 21:02:47', 1, 1);
...
INSERT INTO `dish` VALUES (68, '鸡蛋汤', 21, 4.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/c09a0ee8-9d19-428d-81b9-746221824113.png', '配料：鸡蛋，紫菜', 1, '2022-06-10 10:54:25', '2024-03-24 15:10:32', 1, 1);
INSERT INTO `dish` VALUES (69, '平菇豆腐汤', 21, 6.00, 'https://sky-itcast.oss-cn-beijing.aliyuncs.com/16d0a3d6-2253-4cfc-9b49-bf7bd9eb2ad2.png', '配料：豆腐，平菇', 1, '2022-06-10 10:55:02', '2024-03-24 15:10:31', 1, 1);
...
INSERT INTO `dish_flavor` VALUES (103, 65, ' VV', '[\"不辣\",\"微辣\",\"中辣\",\"重辣\"]');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '员工信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `employee` VALUES (2, '办式交想类斗', '1222', 'e10adc3949ba59abbe56e057f20f883e', '18767683132', '1', '311082200212308911', 1, '2024-03-23 18:14:27', '2024-03-23 18:14:27', 10, 10);
INSERT INTO `employee` VALUES (5, '七红点油安', '陆杰', 'e10adc3949ba59abbe56e057f20f883e', '19862756081', '女', '311082200212308911', 1, '2024-03-23 18:38:43', '2024-03-23 18:38:43', 1, 1);
INSERT INTO `employee` VALUES (6, '进国热活', '黎芳', 'e10adc3949ba59abbe56e057f20f883e', '18606734149', '女', '85', 1, '2024-03-24 09:59:16', '2024-03-24 09:59:16', 1, 1);
INSERT INTO `employee` VALUES (7, '约联工照界', '卢勇', 'e10adc3949ba59abbe56e057f20f883e', '13515883365', '女', '50', 1, '2024-03-24 10:13:51', '2024-03-24 10:13:51', 1, 1);
INSERT INTO `employee` VALUES (8, '什县今化反', '易超', 'e10adc3949ba59abbe56e057f20f883e', '13487274276', '女', '91', 1, '2024-03-24 10:18:39', '2024-03-24 10:18:39', 1, 1);
INSERT INTO `employee` VALUES (9, '只改空有', '吴强', 'e10adc3949ba59abbe56e057f20f883e', '18623304725', '女', '64', 1, '2024-03-26 21:32:07', '2024-03-26 21:32:07', 1, 1);
INSERT INTO `employee` VALUES (10, '量律是器效象', '罗杰', 'e10adc3949ba59abbe56e057f20f883e', '19845572171', '女', '13', 1, '2024-03-26 21:37:03', '2024-03-26 21:37:03', 1, 1);
...
CREATE TABLE `order_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '订单明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of order_detail
-- ----------------------------
INSERT INTO `order_detail` VALUES (1, '123', 'https://sky-take-out.oss-cn-hangzhou.aliyuncs.com/1ab641fc-6525-4cae-93a3-14a7d5877fa3.jpg', 1, NULL, 3, NULL, 1, 123.00);
...
CREATE TABLE `orders`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, '1711611205173', 5, 2, 1, '2024-03-28 15:33:25', '2024-03-28 15:38:36', 1, 1, 130.00, '', '18767683132', NULL, NULL, '18767683132', NULL, NULL, NULL, '2024-03-28 16:33:00', 0, '2024-08-01 18:47:09', 1, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '套餐' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of setmeal
-- ----------------------------
INSERT INTO `setmeal` VALUES (2, 24, '张学龙', 500.00, 1, '傻逼', 'https://sky-take-out.oss-cn-hangzhou.aliyuncs.com/f8ae0c1d-6477-4c89-a5fc-036972c58b56.jpg', '2024-03-24 18:03:34', '2024-03-24 21:02:47', 1, 1);
INSERT INTO `setmeal` VALUES (3, 24, '123', 123.00, 1, '123', 'https://sky-take-out.oss-cn-hangzhou.aliyuncs.com/1ab641fc-6525-4cae-93a3-14a7d5877fa3.jpg', '2024-03-27 16:43:38', '2024-03-27 16:43:38', 1, 1);
...
CREATE TABLE `setmeal_dish`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '套餐菜品关系' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of setmeal_dish
-- ----------------------------
INSERT INTO `setmeal_dish` VALUES (7, 2, 63, '香锅牛蛙', 88.00, 1);
INSERT INTO `setmeal_dish` VALUES (8, 2, 64, '馋嘴牛蛙', 88.00, 1);
INSERT INTO `setmeal_dish` VALUES (9, 2, 67, '鮰鱼2斤', 72.00, 1);
INSERT INTO `setmeal_dish` VALUES (10, 3, 62, '金汤酸菜牛蛙', 88.00, 1);
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '用户信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '123456', NULL, NULL, NULL, NULL, NULL, '2024-03-27 16:49:00');
INSERT INTO `user` VALUES (2, 'oPMjF62rB-jL-IYUAvwYkzDtDz6E', NULL, NULL, NULL, NULL, NULL, '2024-03-28 15:31:02');
